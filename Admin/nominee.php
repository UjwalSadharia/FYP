...
<body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0">
            ...
            <li class="nav-items">
                <a href="nominee.php"  style="background-color:#ededed" class="nav-link text-dark">
    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="dynamic_content">
            <!--content  -->
            <h2 class="display-4 text-white">Nominee Of Customer</h2>
            <p class="lead text-white mb-0">All the details of Nominee's are listed below.</p>
    ...
    <script>
        function loadData() {
            $('.table_parent').load('nominee_ajax/display.php');
        }
        loadData();
