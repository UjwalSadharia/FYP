<?php
    ...
    if(isset($_POST['que'])){
        ...
        $sql = "INSERT INTO chatbot(question,reply)VALUES('{$que}','{$reply}')";
...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      ...
      <li class="nav-items">
        <a href="chatbot.php" style="background-color:#ededed"  class="nav-link text-dark">
  ...
  <div class="page-content p-5" id="content">
    ...
    <div class="dynamic_content">
      <!--content  -->
      <h2 class="display-4 text-white">Talk With Expert</h2>
      <p class="lead text-white mb-0">Add question and reply fot chatbot</p>
      ...
      <div class="botWrapper">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="que" rows="3"></textarea>
                <small>Note: Seprate similar question with   ||  Pipe</small>
            </div>
            <div class="mb-3">
                <label for="reply" class="form-label">Reply</label>
                <textarea class="form-control" id="reply" rows="3"></textarea>
            </div>
            <button type="submit" id='insert' class="btn btn-primary text-center">Add</button>
    </div>
      </div>
      <!-- content end -->
    </div>
  ...
  <script>
      $(document).ready(function(){
            ...
            $('#insert').click(function(e){
                ...
                if(que == '' || reply == ''){
                    alert('Fill Question & Reply to insert');
                }else{
                    $.ajax({
                        type:'POST',
                        data:{
