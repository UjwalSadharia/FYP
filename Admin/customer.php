...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      ...
      <li class="nav-items">
        <a href="customer.php" style="background-color:#ededed" class="nav-link text-dark" id="customer">
  ...
  <div class="page-content p-5" id="content">
    ...
    <div class="dynamic_content">
      <!--content  -->
      <h2 class="display-4 text-white">Customer Details</h2>
      <p class="lead text-white mb-0">All the details of Customer are listed below.</p>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      function loadData(){
      $('.table_parent').load('customer_ajax/display.php');
      }
      loadData();
